...
__device__ inline xlns32 xlns32d_fma(xlns32 a, xlns32 b, xlns32 c)
{
	return xlns32d_add(xlns32d_mul(a, b), c);
}

__device__ inline xlns32 xlns32d_relu(xlns32 x)
{
	return xlns32d_is_negative(x) ? xlns32_zero : x;
}
